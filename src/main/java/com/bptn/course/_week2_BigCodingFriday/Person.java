package com.bptn.course._week2_BigCodingFriday;
...
public class Person {
    ...
    public boolean verifySSN(String ssn){
        if (this.ssn == null || ssn == null){
            System.out.println("You cannot have a null SSN ");
            return false;
        } 
...
//I was trying to practice the try-catch here. Please ignore. Thank you
    /**public boolean verifySSN(String ssn){
       try { 
        ...
        return false;
           ...
           System.out.println("There is a null pointer exception here " + e.getMessage());
           return false;
       }
    }*/
